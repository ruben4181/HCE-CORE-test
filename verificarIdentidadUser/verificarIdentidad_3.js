//Solicitando con numeros aleatorios de usuarios no regristrados
utils = require('../utils');
...
for(var i=0; i<=1000; i++){
  ...
  //Numeros generados aleatoriamente para el id del usuaior (usuarios no registrados)
  config['data'] = {id : utils.genRandomNumber(10), password : "PWD"}
