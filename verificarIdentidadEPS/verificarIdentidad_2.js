//Solicitar token para entidad registrada pero sin password correcto
utils = require('../utils');
...
for(var i=0; i<=1000; i++){
  config['data'] = {id : 1, password : utils.genRandomString(8)} //Contraseña incorrecta generada aleatoreamente
